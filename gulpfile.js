...
gulp.task('json:replace', function () {
    return gulp.src('./build/scripts/json/*.json')
        .pipe(gulpReplace('dataBlogTitleJsonEscaped', '<data:blog.title.jsonEscaped/>'))
        .pipe(gulpReplace('dataBlogHomepageUrlJsonEscaped', '<data:blog.homepageUrl.jsonEscaped/>'))
        .pipe(gulpReplace('dataBlogSearchUrl', '<data:blog.searchUrl.jsonEscaped/>'))
        .pipe(gulpReplace('dataPostUrlCanonicalJsonEscaped', '<data:post.url.canonical.jsonEscaped/>'))
        .pipe(gulpReplace('dataPostTitleJsonEscaped', '<data:post.title.jsonEscaped/>'))
        ...
        .pipe(gulpReplace('dataPostDateIso8601JsonEscaped', '<data:post.date.iso8601.jsonEscaped/>'))
        .pipe(gulpReplace('dataPostLastUpdatedIso8601JsonEscaped', '<data:post.lastUpdated.iso8601.jsonEscaped/>'))
        .pipe(gulpReplace('dataPostAuthorNameJsonEscaped', '<data:post.author.name.jsonEscaped/>'))
